/* ============================================================================
 * MON 512B  XMSGCallA (A5XMS)  -  pseudo-C model for an emulator
 * SINTRAN III VSX/500 L.  ND-500 -> ND-100 XMSG gateway (level-12 call).
 * MON 512B and MON 513B share ONE body BYTE-FOR-BYTE: L07 symbols
 * A5XMS = B5XMS = 142253B.  This file models the shared body.
 *
...
/* Entry 142253B = A5XMS = B5XMS.  On entry X = ND-500 message cursor,
 * T = message-buffer bank (set up by the caller / level-12 GOSW).             */
int mon_xmsg_call_a(mon_regs *r)
{
...
/* Callers:
 *   MON 512B XMSGCallA:  mon_xmsg_call_a(r);   (A5XMS = 142253)
 *   MON 513B XMSGCallB:  mon_xmsg_call_a(r);   (B5XMS = 142253, same body)
 */
