...
| NPL-1896D      | BPUN | NORD-PL Language       |
...
The only change is:  
listing of "empty" library marks is removed.

An empty library mark is a library mark or an expression of library marks that has the value FALSE, thereby skipping the code behind it upto next ". 
...
Date 87.05.20 | Norsk Data A.S | Page 3 of 4  
---|---|---  
**PROGRAM DESCRIPTION** |   |    
Product Name | Reg. no. | Category  
**SUBSYSTEM PACKAGE II** | 210400B | STIN  
...
|----------------|-------------------|-------------------------|
| 1880D          | 70 70             | (BPUN-FILES)DITAP-1880D |
| F32-FMAC-1920C | -1 -3             | (BPUN-FILES)F32-FMAC-1920C |
| MAC-32-1626C   | -1 -3             | (BPUN-FILES)F32-MAC-1626C |
...
I'm sorry, the image appears to be blank. Could you please provide a different image or more specific context so I can assist you better?
