...
| Num | File name        | Type | T | Public | Friend | Own  | Pages | Bytes |
|-----|------------------|------|---|--------|--------|------|-------|-------|
| 0   | BG-DRIV01-B03    | BRF  | I | RWACD  | RWACD  | RWACD| 0     | 13458 |
...
| 10  | D08078           | VTM  | I | RWACD  | RWACD  | RWACD| 2     | 625   |
...
|----------|------|-----------------|------------|---------|
| ND-100 | 48 bits | SIN III VS | > = I |

| ND-no. | Product name |
|--------|--------------|
| ND 321 | NOTIS-terminal with graphic option |
| ND 447 | Philips printer |
| ND 448 | Philips printer |
| ND 424 | Epson printer |
| ND 218 | HP-plotter |
...
| Directory Name: 10724B00-EN-1 | User Name: FLOPPY-USER |
|-----------------------------|-------------------------|
...
| 205957B | INST-BG14B-800 | COM | I | 4 | 6144 | Installation job. |
| 205284B | BG-EX01-EN-B00 | PLOT | I | 2 | 415 | Demo-file |
| 205285B | BG-EX02-EN-B00 | PLOT | I | 2 | 328 | Demo-file |
| 205286B | BG-EX03-EN-B00 | PLOT | I | 2 | 311 | Demo-file |
| 205287B | BG-EX04-EN-B00 | PLOT | I | 2 | 425 | Demo-file |
| 205288B | BG-EX05-EN-B00 | PLOT | I | 2 | 284 | Demo-file |
| 205958B | BG-EX06-EN-B00 | PLOT | I | 2 | 1000 | Demo-file |
| 205959B | INST-BG14B-B00 | PROG | I | 14 | 25393 | Installation program |
...
| 205957B  | INST-BG14B-B00  | COM  | I | 4   | 6144  | Installation job.             |
| 205279B  | BG-EXO10-NO-B00 | PLOT | I | 2   | 353   | Demo-file                     |
| 205280B  | BG-EXO2-NO-B00  | PLOT | I | 2   | 319   | Demo-file                     |
| 205281B  | BG-EXO3-NO-B00  | PLOT | I | 2   | 320   | Demo-file                     |
| 205278B  | BG-EXO4-NO-B00  | PLOT | I | 2   | 443   | Demo-file                     |
| 205282B  | BG-EXO5-NO-B00  | PLOT | I | 2   | 314   | Demo-file                     |
| 205962B  | BG-EXO6-NO-B00  | PLOT | I | 3   | 701   | Demo-file                     |
| 205959B  | INST-BG14B-B00  | PROG | I | 14  | 25393 | Installation program          |
| 205960B  | XCOM            | PROG | I | 60  | 182272| Installation system           |
...
| Date       | Company      | Page  |
|------------|--------------|-------|
| 85.05.15   | Norsk Data A/S | 3 of 17 |
...
- The instruction 'DATAFILE=?' in diagram file for line graphics works according to the specifications.

## 2 Known, But Not Corrected Errors

- The instructions 'XRANGE:' and 'YRANGE:' don't work as expected. These two instructions require two parameters each for the lowest and highest value along the actual axis. These two values are used in the algorithm that calculates tic marks with 'nice' labels. The maximum and minimum value along the axis may be adjusted to get 'nice' values on the tic marks.

- If the execution of NOTIS-BG is broken when preparing diagrams for Philips or Epson, the following files may exist on the account afterwards:
...
| Date       | Norsk Data A/S      | Page 4 of 17    |
|------------|---------------------|-----------------|
| Product    | Name                | ND-no. | Category |
| NOTIS-BG for ND-100 | (Business Graphics) 48 bits f1. | 10724B | STPR |
...
- ROTATION=90: This command (instruction) may be used to rotate the diagram 90 degrees. The diagram will then be plotted on an A4 portrait format instead of an A4 landscape format. In this version of NOTIS-BG it is not possible to rotate any other angles. The instruction has to be used in the first part of the diagram file.
...
| Date       | Norsk Data A/S        | Page 6 of 17 |
|------------|-----------------------|-------------|
| Product    | Name                  | ND-no.      | Category |
...
| Name                             | ND-no.  | Category  |
|----------------------------------|---------|-----------|
| NOTIS-BG for ND-100 (Business Graphics) 48 bits fl. | 10T24B | STPR      |
...
| Date       | Norsk Data A/S      | Page 8 of 17       |
|------------|---------------------|--------------------|
| Product    | Name                | ND-no.  | Category |
|            | NOTIS-BG for ND-100 | 10724B  | STPR     |
|            | (Business Graphics) |          |          |
...
∂ENTER ....................  
∂NOTIS-BG-ENG-B00,<diagram-file name>,<output device>,CC  
∂NOTIS-BG-ENG-B00,<diagram-file name>,<output device>,CC  
∂NOTIS-BG-ENG-B00, ....  
∂NOTIS-BG-ENG-B00, ....
...
When plotting on a A3 sheet, the 'SIZE-OF-PLOT=' instruction must be used to enlarge the diagram to fit the sheet.
...
- Maximum number of bars in a bar chart is 25 groups with 2 bars each.
...
Set these values in the Communications Switches Menu for NOTB9S terminals (ND-246 or ND-320 with graphic option) that will be used to view diagrams with NOTIS-BG:
...
Find the terminal's Logical Device Number with the SINTRAN command ØWHO-IS-ON. Continue as shown here, typing the _underlined_ commands and parameters. XXXX represents number provided by system.

```
ØSINTRAN-SERVICE
*CHANGE-DATA <Logical Device Number>,J,I,Y,Y,Y
ØFLAG/ XXXXXXX _1000_
ØNTREG/ XXXXXXX _44005_
*EXIT
```
...
- Set the switches at the back of the plotter for 9600 BAUD, A4 paper, direct line and even parity (7 bit character length): 010001010. For further details, see pages 2-21 and 2-23 in the Operation and Interconnection Manual accompanying the HP-plotter.
...
```
ND-100 ---- 325301 ---- HP-7475
```

## Alternative 2: Connection via 2 local KM-1D modems

```
ND-100 ---- 325345 ---- M ---- CL ---- M ---- 325300 ---- HP-7475
```
- CL = Current Loop
- M = Local KM-1D Modem
...
- Log in as user SYSTEM and set a file name for the line:
  ...
  ```plaintext
  ØSET-PERIPH-FILE <file name>,<Logical Device Number>
  ```

- Our plotter has the file name HP-PLOTTER and Logical Device Number 54D. The command is thus:

  ```plaintext
  ØSET-PER-FILE "HP-PLOTTER",54D
  ```

- Define the file access so that a user who will be working with the plotter has file access RWC(D):

  ```plaintext
  ØSET-FILE-ACCESS HP-PLOTTER,RWC,RWC,RWCD
  ```

- Find the background program for the terminal line with the SINTRAN command ØLIST-DEVICE, and abort the background program:

  ```plaintext
  ØLIST-DEVICE <Logical Device Number>,0  
  NNNN  
  ØABORT NNNN
  ```
...
| Product  | Name                                 | ND-no. | Category |
|----------|--------------------------------------|--------|----------|
|          | NOTIS-B6 for ND-100                  | 10724B | STPR     |
|          | (Business Graphics) 48 bits fl.      |        |          |
...
```
  ND-100  ---- 325345 ---- [M] ---- [M] ---- 325305 ---- TEK-4105
                  CL              
```
...
```
ØSINTRAN-SERVICE  
*CHANGE:DATA ⟨Logical Device Number⟩,J,Y,Y,Y
ØFLAG/ XXXXXX 1000
ØNTREG/ XXXXXX 44005
*
*EXIT
...
`@10724B00-EN-1: FLOPPY-USER 》 INST-BG14-B-B00`
...
The files BG-LOAD:LOGG and BG-DUMP:LOGG will be created on user SYSTEM, and contain information about the installation. They should not be deleted. The files X-COM-nn:SAVE and X-COM-nn:MODE (where nn is terminal number on the terminal used for installation) should be deleted after installation. (They cannot be deleted automatically in the installation job).
