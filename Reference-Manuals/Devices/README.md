...
**Key Topics:** SMD disk interface, 15 MHz SMD controller, ECC error-correcting codes, IOX
programming specification, disk device register addresses, track/sector format, DMA transfer,
interrupt handling, SINTRAN III SMD disk driver, floppy subsystem, HAWK cartridge disk, backwiring
and connector lists, signal definition lists, test programs
