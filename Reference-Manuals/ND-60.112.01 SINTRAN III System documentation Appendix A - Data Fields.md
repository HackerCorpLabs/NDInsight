...
1. Listing of files SINI-GEN to SIN4-GEN. This is produced from NORD-10, S/N 10-54, October 9, 1978.
...
In Section 2, the data fields are listed with its name, label name, person responsible and paragraph number in the SINTRAN III listing. They occur in the same order as in the SIN¯GEN listings.
...
Section 4 shows the meaning of the different bits in the words DFLAG, TSPEED and TYPIRING (see, for instance, DTxxR data field).
...
|------------------------------------------|-------|
| Monitor work field for demand            | NDEMZ |
...
| Big disk (≥ 10 mby)                        | BIGD1         |                  |
| Big disk 2                                 | BIGD2         |                  |
| Drum 1                                     | DDRUM         | see DRFIE        |
| Drum 2                                     | DRUM2         | -32 - +20        |
...
| INBT/OUTBT for mag. tape contr. 1          | MTD1fi        |                  |
|                                            | MTD12         |                  |
|                                            | MTD13         |                  |
|                                            | MTD01         |                  |
|                                            | MTD02         |                  |
...
| INBT/OUTBT cassette 1, input               | CADI11        |                  |
| INBT/OUTBT cassette 1, output              | CADO11        |                  |
| INBT/OUTBT cassette 2, input               | CADI12        |                  |
| INBT/OUTBT cassette 2, output              | CADO2         |                  |
| Versatec DMA, contr. 1                     | VEIE          |                  |
| OUTBT Versatec, contr. 1                   | VED011        |                  |
| Versatec DMA, contr. 2                     | VE2FI         |                  |
| OUTBT Versatec, contr. 2                   | VED02         |                  |
| Floppy disk, contr. 1                      | FDDI[l        |                  |
| INBT/OUTBT F.D., contr. 1, drive0          | F1U0[l        | see sdCUJ.lmJKI  |
| INBT/OUTBT F.D., contr. 1, drive 1         | F1U1[l        | see sF.YJ.IxX#O  |
| INBT/OUTBT F.D., contr. 1, drive 2         | F1U210        |                  |
| Floppy disk, contr. 2                      | F1U220        |                  |
| INBT/OUTBT F.D., contr. 2, drive0          | FDMD2         |                  |
| INBT/OUTBT F.D., contr. 2, drive 1         | F2U0D1        |                  |
| INBT/OUTBT F.D., contr. 2, drive 2         | F2U1[l        |                  |
| CDC DMA link (not used)                    | CDI]E         |                  |
|                                            | CDCUT         |                  |
| BSC DMA link (HASSP)                       | CDHNV         |                  |
| BSC DMA, modem 1, contr. input             | HDM1fi        | SB               |
| BSC DMA, modem 1, contr. output            | HDM0I]        |                  |
| BSC DMA, modem 1, monitor call, input      | HDFH          |                  |
...
|--------------------------------------------|---------|
| BSC DMA, modem 6, contr. input             | HDMl6   |
| BSC DMA, modem 6, contr. output            | HDM06   |
| BSC DMA, modem 6, monitor call, input      | HDFI6   |
| BSC DMA, modem 6, monitor call, output     | HDF06 SB|
| ACM, accumulator, unit 1                   | DACMl   |
| ACM, accumulator, unit 5                   | DACM5   |

## 28.5 Terminal Data Fields

| Terminal Data Fields            | Label  |
|---------------------------------|--------|
...
| Paper Tape Reader  | Label  |
|--------------------|--------|
| Paper tape reader 1 | DREAR  |
| Paper tape reader 2 | DREAZ  |

## 28.8 Modem Data Fields

| Modem  | Label   |
|--------|---------|
| Modem 1, input/output | IDMO11 |
|                       | UDMO11 |
| Modem 2, input/output | IDMO06 |
|                       | UDMO06 |
| ...                   | ...    |
| Modem 16, input/output | IDMO16 |
|                       | UDM16  |
...
| TET  | Label  |
|------|--------|
| TET 1, input/output | DTEL1 TK  |
|                     | DTL1 TK   |
| TET 2, input/output | DTEL2 TK  |
|                     | DTL2 TK   |
| ...                 | ...       |
| TET 15, input/output | DTEL15 TK |
|                     | DTL15 TK  |
...
| Photosetter  | Label  |
|--------------|--------|
| Photosetter 1 | DPHOT TK  |
| Photosetter 2 | DPHO2 TK  |
| Photosetter 3 | DPHO3 TK  |
| Harris photos 1, input/output | HA1R TK  |
|                               | HA1W TK  |
| Harris photos 2, input/output | HA2R TK  |
|                               | HA2W TK  |
...
# Graf Cassette Data Fields

| Description                        | Code |
|------------------------------------|------|
| Graf cassette 1, input/output      | GR1R TK  |
|                                    | GR1W TK  |
| Graf cassette 2, input/output      | GR2R TK  |
|                                    | GR2W TK  |

# Tape Punch Data Fields
...
| Line 1, input   | TTIL1  |
| Line 1, output  | TTUL1  |
| Line 6, common  | CM06 K0 |
| Line 6, input   | TTIL6  |
| Line 6, output  | TTUL6  |

See also: "SINTRAN III Communication System Documentation", Chapter 4.

# Communication Channel Data Fields
...
|                                      | S161W  |
| Line 2, channel 1, input/output      | S012A K0 |
|                                      | S012W  |
| Line 6, channel 16, input/output     | S166R  |
|                                      | S166W  |
| (Line n, channel mm, input/output)   | SmnnR  |
|                                      | SmnnWJ |
...
| ..........                                                    |                   |
| Selector module, ACM no. 1, SM no. 12                         | SLM12 see SMN2, SyNz |
...
| ..........                                                    |                   |
| Semigraphic buffer, ACM no. 1, buffer no. 7                   | SMN7 see SMN2, SyNz |
...
| Graphic buffer, ACM No. 3, buffer no. 1                       | G3B1 see GRB2, GYB2 |
...
|                                     | DR503  |
|                                     | DR504  |
| Universal DMA interface ND-850     | DMA1   |
|                                     | JFB    |
| Extra clock no. 2                  | DMA7   |
| Extra clock no. 3                  | CLOC2  |
| External interrupt level 13        | CLOC3  |
|                                     | INEX1  |
...
|                                                                      | ...            |
|                                                                      | see IDxxI, IDxxO |
| I.D., character orient, no. 1, input                                 | IDO11          |
| I.D., character orient, no. 1, output                                | IDO10          |
| I.D., block orient, no. 1, input                                     | IBO11          |
| I.D., block orient, no. 1, output                                    | IBO10          |
| ......                                                               |                |
| I.D., character orient, no. 5, input                                 | IDO51          |
| I.D., character orient, no. 5, output                                | IDO50          |
| I.D., block orient, no. 5, input                                     | IBO51          |
| I.D., block orient, no. 5, output                                    | IBO50          |
| I.D., character orient, no. 6, input                                 | IDO61          |
| I.D., character orient, no. 6, output                                | IDO60          |
| ........                                                             |                |
| I.D., character orient, no. 30, input                                | ID301          |
| I.D., character orient, no. 30, output                               | ID300          |
| I.D. for append remote, Command, IBM Hasp 3780                       | IIBMI          |
|                                                                      | IIBM0          |
| I.D. for append remote command, CDC 200 user                         | ICDCI          |
|                                                                      | ICDCO see IDxxI, IDxxO |
| I.D. for append remote command, UNIVAC NTR                           | IUNII          |
|                                                                      | IUNIO          |
| I.D. for append remote command, Honeywell, Gerts 115                 | IHONI          |
|                                                                      | IHONO          |
| User restart program ("Connect")                                     | URERT HKD      |

# 28.23 Batch

| Batch device no. 1, input                                            | BT01R          |
| Batch device no. 1, output                                           | BT01W          |
| Batch device no. 1, batch kO, output                                 | BT010 see IDxxO|
| Batch device no. 1, batch kα, input                                  | BT011 see IDxxI|
| ........                                                             |                |
| Batch device no. 10α, input                                          | BT10R          |
| Batch device no. 10α, output                                         | BT10W          |
| Batch device no. 10α, batch kO, output                               | BT100 see IDxxO|
| Batch device no. 10α, batch kα, input                                | BT101 see IDxxI|
...
| Digital output (ND)811), no. 20                 | NDO20  |
| Digital input (ND811), no. 20                   | ND020  |
...
| -11          | DRIVER  | DDRIV     | Restart after interrupt     |
| 0            | RESLINK | 0         |                             |
| 1            | RTRES   | 0         |                             |
| 2            | BWLINK  | -2        |                             |
...
| 53    | CPAT♎︎ | 0        | Correcting pattern word no. 1 |
| 52    | CDISP  | 0        | Correcting memory address |
| 51    | CPAT2  | 0        | Correction pattern word no. 2 |
| 50    | TYPEC  | 0        | Control word type (1 = new, 0 = old) |
| 47    | SVLSB  | 0        | Last block address 2 used (cylinder) |
| 46    | SVLBA  | 0        | Last block address 1 used (surface and sector) |
| 45    | ERRCT1 | -4       | Error counter for ordinary retrials |
| 44    | ERRCT2 | -34      | Error counter for marg. rec. cycles |
| 43    | STRTRY | 0        | No. of ordinary retrials for read |
| 42    | SWTRY  | 0        | No. of ordinary retrials for write |
| 41    | SMARG  | 0        | No. of marg. rec. cycles retried |
| 40    | SVLCQ  | 0        | Last control word used |
| 37    | SCADR  | 0        | Expected memory address after transfer |
| 36    | MARGC  | 0        | Marg. rec. cycle flag (-1 = marg. rec., 0 = nor. op.) |
| 35    | BUSFL  | 0        | Transfer flag (1 = transfer started) |
| 34    | SVALCA | 0        | Last memory address used |
| 33    | SVLVWC | 0        | Last word counter used |
...
| 13    | BLSZ   | 100      | Block size |
| 12    | TRNSF  | BDISK    | Device address |
| 11    | BUSY   | BUSYE    | Busy return |
| 10    | FINISH | COOPT    | Transfer finished |
| 7     | ERROR  | PFEIL    | Error return from driver |
| 6     | TMSUB  | MTMRS    | Time-out routine |
| 5     | TMR    | 0        | Time-out counter |
| 4     | TTMIR  | -4       | Start value of TMR |
| 3     | HDEV   | 134      | Hardware device no. (i.e., IOX 1540) |
| 2     | STDW/V | CTRDl    | Start address of driver |
...
| 12    | TRMFLG     | not used                                        |
| 13    | BREGC      | not used                                        |
| 14    | NEMA1      | Initial memory address                          |
| 15    | NEMA2      | Initial memory address                          |
| 16    | CMAD1      | Current memory address                          |
| 17    | CMAD2      | Current memory address                          |
| 20    | MONTYP     | Disk type/unit (bit 0 - 3, 1 = 288 Mb)          |
...
| 3            | TYPRING | 110002   | Device type bits and ring                          |
...
| 27           | BCHISTS | 0        | Batch input status input file cannot be accessed. <br> Batch input status = 0: input file cannot be accessed because of an error in % 0: otherwise |
| 30           | DER0(2) | 0, 0     | Register block                                     |
| 32           | DER2(6) | 0, ..., 0| Register block                                     |
| 33           | BREGBLOCK | DER0   | Register save at escape                            |
...
| 2   | 5ESCZSET | Escape has been typed but not saved  |
...
| 0            | RESLINK  | 0        | Reservation link                                           |
| 1            | RTRES    | 0        | Reserving RT program                                       |
| 2            | BWLINK   | •_2_     | Beginning of waiting queue                                 |
| 3            | TYPERING | 110002   | Device type bits and ring                                  |
| 4            | ISTATE   | 0        | 0 = idle, 1 = busy, -1 = no wait mode                      |
| 5            | MLINK    | 0        | Monitor queue link                                         |
| 6            | MFUNC    | IORES    | Monitor level function address                             |
| 7            | IOTRANS  | 0        | Called from INBT/OUTBT to transfer                         |
...
| 11           | SETDV    | CEXIT    | IOSET routine                                              |
| 12           | DFOPP    | BTxxR    | Opposite data field for two-way devices                    |
...
| 13           | DERROR    | 0        | Error code                                                         |
| 14           | BUFS1     | 0        | Start of ring buffer                                               |
...
| 30           | NOWRITE   | 0        | Number of characters to read/write                                 |
| 31           | CPARM (5) | 0, *+3, *&minus;6, &minus;410 | Parameter list for MTRANS (including first word in memory buffer address) |
...
| Relat. Addr. | Symbol     | Contents  | Explanation                                           |
|--------------|------------|-----------|-------------------------------------------------------|
| _1           | ADRBHEAD   | 0         | Buffer head address                                   |
| 0            | RESLINK    | 0         | Reservation link                                      |
| 1            | RTRES      | 0         | Reserving RT program                                  |
| 2            | BWLINK     | *–2       | Beginning of waiting queue                            |
| 3            | TYPRING    | 113000    | Device type bits and ring                             |
...
| 12           | DFPOP      | CADIX     | Opposite data field for two-way devices               |
| 13           | DERROR     | 0         | Error code                                            |
| 14           | BUFST      | 0         | Start of ring buffer                                  |
| 15           | MAX        | 1000      | Buffer capacity                                       |
| 16           | BHOLD      | 0         | Number of characters in buffer                        |
...
| 22           | CLOGDV     | 575       | Logical unit number for DMA data field                |
| 23           | DPDEV      | 574       | Logical unit number for DF data field                 |
| 24           | LCREG      | 0         | Return address after IOTRANS is executed              |
| 25           | CASUN      | x         | Device unit number                                    |
| 26           | CERROR     | 0         | Current error code                                    |
| 27           | LASTC      | 0         | Current character                                     |
| 30           | NOWRE      | 400#      | Number of characters to read/write                    |
| 31           | CPARM (5)  | 1, *,+3, *–65, *–4, 0 | Parameter list for MTRANS (including first word in memory buffer address) |
| 36           | MABUF      | 0         | Second word in memory buffer address                  |
| 37           | VEFUNC     | 0         | Not used                                              |
| 40           | CIOLOG     | 20#       | Logical device number                                 |
...
| -42          | CERCODE | 0 | Current error code |
...
| -22          | ERRCNT  | 0 | Number of error returns from driver |
| -21          | SERBNB  | 0 | Serious error bits (bit 12: overflow in read bit 10: word counter not zero) |
| -20          | WERRB   | 0 | Not used |
| -17          | AERB    | 0 | Accumulated error bits |
| -16          | TACNS   | ~5 | Number of retries waited before message |
| -15          | TACOUNT | 0 | Retrial counter |
| -14          | MWVCNT  | 0 | Number of times to write erase gap |
...
| 7            | TRIREG  | 0 | Return address on monitor level after transfer |
...
| Relat. Addr. | Symbol    | Contents  | Explanation                                         |
|--------------|-----------|-----------|-----------------------------------------------------|
| -19          | SCREEN    | 0         | Counter for stop on full page                       |
| -7           | EMPTFLAG  | 0         | = 0 when buffer empty and print of last character finished |
|              | TMSUB     | TTOMR     | Time-out subroutine                                 |
|              | TMR       | 0         | Time-out counter                                    |
|              | TTMR      | -3        | Start value of TMR                                  |
|              | HDEV      | IOX440    | IOX instruction                                     |
|              | STDRIV    | DWRIT     | Start address of driver                             |
| -1           | DRIVER    | DWRIT     | Restart after interrupt                             |
| 0            | RESLINK   | 0         | Reservation link                                    |
| 1            | RTRES     | 0         | Reserving RT program                                |
| 2            | BWLINK    | -2        | Beginning of waiting queue                          |
| 3            | TYPING    | 110000    | Device type bits and ring                           |
| 4            | ISTATE    | 0         | 0 = idle, 1 = busy, -1 = no wait mode               |
| 5            | MLINK     | 0         | Monitor queue link                                  |
| 6            | MFUNC     | IORES     | Monitor level function address                      |
...
| 11           | SETDV     | CEXIT     | IOSET routine                                       |
| 12           | DIFOPP    | 0         | Opposite data field for two-way devices             |
| 13           | DERROR    | 0         | Error code                                          |
| 14           | BUST      | BUF       | Start of ring buffer                                |
...
| Addr. | Symbol | Contents | Explanation |
|-------|--------|----------|-------------|
| -6    | UU$30  |          | Routine for PLOTT monitor call |
| -5    | STAAD  | 0        | Work cell |
| -4    | KLUMP  | 0        | Save cell |
...
| Relat. Addr. | Symbol | Contents | Explanation |
|--------------|--------|----------|-------------|
| -11          | DRIVER | ENT13    | Driver restart address |
| 0            |        |          | |
| 1            |        |          | |
| 2            |        |          | |
...
| 4            |        |          | |
| 5            |        |          | |
| 6            | MFUNC  | ICØK     | Monitor level function address |
...
| -3           | XTEMI    |          | Save X register while computing CRC on input                       |
| -2           | XTEMO    |          | Save X register while computing CRC on output                      |
| -1           | ISIT     |          | Frame phase bit on input                                           |
| 0            | GSI      |          | Group number on input                                              |
| 1            | ANI      | &        | Status information in input frame                                  |
| 2            | GRI      | &        | Group number for ANI                                               |
| 3            | IRI      | &        | Phase bit for GRI                                                  |
| 4            | ISTATE   |          | Send status (1 = waiting for acknowledge, 0 = otherwise)            |
| 5            | ISH4     | 0, 0, 0  | Last received phase bit on group n                                |
| 11           | GSO      | 0        | Current group number output                                        |
| 12           | CDPLFD   | TTLIN#   | Pointer to line data filed input                                   |
| 13           | SINI#    | CSINL#   | Initializing routine                                               |
| 14           | BSWRT    | CRESLIN# | Initializing routine for remote load                               |
| 15           | PLMSG    |          | Last frame of send queue                                           |
| 16           | PMSMG    |          | First frame of send queue                                          |
| 17           | ISO(M)   | 0, 0, 0  | Last sent phase bit on group n                                    |
| 23           | SEND     | TSENDIN# | Send routine                                                       |
| 24           | BSEND    | TRAWA#   | Send bootstrap routine for remote load                             |
| 25           | RECEIVE  | TRECE#   | Receive routine                                                    |
| 26           | VENTX    | TEXIT#   | Wait routine (half duplex)                                         |
| 27           | RMLNR    |          | Remote line number                                                 |
| 30           | FRFTR    |          | Frames retransmitted                                               |
| 31           | MISTART  |          | Start of current input frame                                       |
| 32           | SBYTS    |          | Number of I field bytes in output frame                            |
| 33           | CUIBUU   |          | Current input buffer                                               |
| 34           | CUUBU    |          | Current output buffer                                              |
| 35           | RGSI     |          | Temporary variable to hold last received group number              |
| 36           | SGOREN   |          | Number of sequence errors since command started                    |
| 37           | RNACO    |          | Number of NAK's received since command started                     |
| 40           | SNACO    |          | Number of NAK's sent since command started                         |
| 41           | CTRCH    | 0        | Controller and channel of last received frame                      |
| 42           | BADANT   | 0        | Retransmit flag (set when received NAK and by timeout)             |
| 43           | SMI      | 0        | CRC on input                                                       |
| 44           | SMO      | 0        | CRC on output                                                      |
| 45           | ACQFP    | 0        | Write pointer in status information buffer (range 0, 3)            |
| 46           | ACQHP    |          | Read pointer in status information buffer (range 0, 3)             |
| 47           | ACOB     |          | Number of items in status information buffer (range 0, 4)          |
| 50           | IBYTS    | 0        | Number of I field bytes in input frame                             |
| 51           | CURID    | 0        | Address of current input buffer                                    |
| 52           | SPRS     | SESGIN   | Send RT program                                                    |
| 53           | APRS     | RECEM    | Receive RT program                                                 |
| 54           | ACQU(M)  | 0, 0, 0  | Status information buffer                                          |
...
| 1            | RTRES  | 0        | Reserving RT program                   |
| 2            | BWLINK | -2       | Beginning of wait queue                |
| 3            | TYPTING | 0        | Device type bits and ring              |
| 4            | ISTATE | 0        | 0 = idle, 1 = busy, -11 = nowait mode  |
| 5            | MLINK  | 0        | Monitor queue link                     |
| 6            | MFUNC  | 0        | Monitor level function address         |
| 7            | ZPREG  | 0        |                                        |
| 10           | ZXREG  | 0        |                                        |
| 11           | ZTREG  | 0        | Register block                         |
| 12           | ZAREG  | 0        |                                        |
| 13           | ZDREG  | 0        |                                        |
| 14           | ZLREG  | 0        |                                        |
| 15           | ZSREG  | 0        |                                        |
...
| 20           | D0     | 0        |                                        |
| 21           | D1     | 0        |                                        |
| 22           | D2     | 0        | Monitor call parameters                |
| 23           | D3     | 0        |                                        |
| 24           | D4     | 0        |                                        |
| 25-36        |        | 0        | Work area                              |
...
| -5           | TMR        | 0         | Time-out counter                          |
| -4           | TMMR       | 0         | Start value of TMR                        |
| -3           | 5DOIO      | IOX30#    | First IOX instruction                     |
| -2           | 5CIOX      | IOX60#    | Last IOX instruction                      |
| -1           | DRIVER     | RSINS     | Restart address after interrupt           |
| 0            | RESLINK    | 0         |                                           |
| 1            | RTRES      | 0         |                                           |
| 2            | BWLINK     | -2        |                                           |
...
| 16           | 50MT       | 50MTTx    | Magnetic tape routine for NORD-50         |
| 20           |            | +4        |                                           |
| 21           |            | +4        |                                           |
...
| 32           | 50LPIOF    | LDPIO     | SINTRAN III word fetch routine            |
...
| 38           | 50PBC      | 0         | NORD-50 break condition (power fail)      |
| 40           | 50FLA      | 0         | NORD-50 flag                              |
| 42           | 50HIOU     | 0         | NORD-50 head of task queue                |
| 43           | 50SWI (1)  | 0         | Task entry points                         |
| 44           | 50SWI (2)  | 0         |                                           |
| 45           | 50PWF (1)  | 0         |                                           |
| 46           | 50PWF (2)  | 0         |                                           |
| 47           | 50PC (1)   | 0         |                                           |
...
| 27           | MTTFLG  | 0        | MON 144 flag                                   |
| 30           | MRSTA   |          |                                                |
| 31           | 5MRSTA  | 0        | Start address of routine                       |
| 32           | SSREG   | 0        | Originator                                     |
| 33           | STRSI20 | 0        | Segments of originator                         |
| 34           | DRT     | RWRTx    | Processing RT program                          |
| 35           | MCLRG   | 0        | Return address for MC144                       |
| 36           | 0       | 0        |                                                |
| 37           | 0       | 0        |                                                |
| 40           | 0       | 0        |                                                |
| 41           | 0       | 0        |                                                |
...
| 0            | RESLINK | 0             | Reservation link                                           |
| 1            | RTRES   | 0             | Reserving RT program                                       |
| 2            | BWLINK  | \*_-2         | Beginning of waiting queue                                 |
...
| 10           | STDEV   | TEXIT         | Start device                                               |
| 11           | SETDV   | CLICLIO       | IOSET routine                                              |
| 12           | DFPOP   | 0             | Opposite data field for two-way devices                    |
| 13           | DERROR  | 0             | Error code                                                 |
| 14           | BUFST   | 0             | Start of ring buffer                                       |
| 15           | MAX     | 1000          | Buffer capacity                                            |
| 16           | BHOLD   | 0             | Number of characters in buffer                             |
...
| 31           | CPARM   | (5)           | 1, \*_-3, \*_-6, \*-4, 0, Parameter list for MTRANS (including first word in memory buffer address) |
| 36           | MABUF   | 0             | Second word in memory buffer address                       |
| 37           | VEFUNC  | 11            | Modus if versatec (10 = plot, 11 = print)                  |
...
| 11           | MTRANS   | DMXATRV  |                              |
| 12           | 0        |          | Not used                     |
| 13           | DMAPPR   | DMPPRH   | RT program for memory transfer |
| 14           | MEMA1    | 0        |                              |
| 15           | MEMA2    | 0        |                              |
...
| 22           | CXBUFST    | BURF + BUF              | Address of extra buffer                                |
| 21           | CXHENTE(2) | 0, DMLPn                | HENTE pointer in extra buffer                          |
| 20           | 0\|0XC     | 4                       | Code to set out in IOX write control                   |
| 17           | IOXVWC     | IOX433#                 | Code for IOX write control                             |
| 16           | IOXRS      | IOX432#                 | Code for IOX read status                               |
| 15           | IOXVWD(2)  | IOX431#                 | Code for IOX write data                                |
| 13           | BLSZ       | 0                       | Not used                                               |
| 12           | LPSMF      | THDLF                   | Address of monitor function routine                    |
| 11           | CBHOLD     | 0                       | Current number of bytes in device buffer               |
| 10           | CHENTE     | 0                       | HENTE pointer in device buffer                         |
| 7            | ERROR      | .                       | Error return from driver                               |
| 6            | TMSUB      | DLPTM                   | Time-out subroutine                                    |
| 5            | TMR        | 0                       | Time-out counter                                       |
| 4            | TTMIR      | -3                      | Start value of TMR                                     |
| 3            | HDECV      | IOX430#                 | IOX instruction (i.e., IOX 430)                        |
| 2            | STDRV      | TLPRI                   | Start address of driver                                |
| 1            | DRIVERR    | CLP10                   | Restart address after interrupt                        |
| 0            | RES LINK   | 0                       | Reservation link                                       |
| 1            | RTRES      | 0                       | Reserving RT program                                   |
| 2            | BWULINK    | -2                      | Beginning of waiting queue                             |
| 3            | TYPEJNG    | 2006                    | Device type bits and ring                              |
| 4            | ISTATE     | 0                       | 0 = idle, 1 = busy, -1 = no wait mode                  |
| 5            | MUNIK      | 0                       | Monitor queue link                                     |
| 6            | MFUNC      | RETRA                   | Monitor level function address                         |
| 7            | TRLREG     | 0                       | Return address on monitor level after transfer         |
| 10           | HSTAT      | 0                       | Hardware status from driver                            |
| 11           | MTRANS     | MTRNS                   | Monitor level routine to activate driver               |
| 12           | MRTREF     | 0                       | Not used                                               |
| 13           | BREGG      | DILPf1                  | Address of H/O data field                              |
| 14           | MEMMA1     | 0                       | Not used                                               |
| 15           | MEMA2      | 0                       | Not used                                               |
| 16           | CMADI1     | 0                       | Not used                                               |
| 17           | CMAD2      | 0                       | Not used                                               |
| 20           | CLEDV      | DMLPC                   | Address of clear device routine                        |
| 21           | PVEFUNC    | DILPX + 37              | Address of VEFUNC in H/O data field                    |
...
| 12            | DFPOP   | 0          | Not used                                           |
| 13            | DERROR  | 0          | Error code                                         |
| 14            | BUFST   | BUFR + BUF | Start of ring buffer                               |
...
| -3           | HDEV      | IOX INST            | IOX instruction (i.e., IOX 400)               |
| -2           | STDRV     | DTAPR               | Start address of driver                       |
| -1           | DAUVER    | WT12                | Restart address after interrupt               |
| 0            | RESLNK    | 0                   | Reservation link                              |
| 1            | RTRES     | 0                   | Reserving RT program                          |
| 2            | BWWLNK    | *—2                 | Beginning of wait queue                       |
| 3            | TYPRING   | 110000              | Device type bits and ring                     |
| 4            | ISTATE    | 0                   | 0 = idle, 1 = busy, —1 = no wait mode         |
| 5            | MLNK      | 0                   | Monitor queue link                            |
| 6            | MFUNC     | IORES               | Monitor level function address                |
...
| -33          | SVLWC   | 0        | Last word counter used |
| -32          | TRG     | 0        | Register when calling driver (real = TADRG) |
| -31          | ARG     | 0        | Register when calling driver (real = TADRG) |
| -30          | DRG     | 0        | Register when calling driver (real = TADRG) |
| -27          | XRG     | 0        | Register when calling driver (real = TADRG) |
...
| -15          | TACOUNT | 0        | Retrial counter |
| -14          | COMFL   | 0        | Compare flag |
| -13          | BLSZ    | 20Q      | Block size |
| -12          | TRNSF   | CDISK    | Driver address |
| -11          | BUSY    | BUSYE    | Busy return |
| -10          | FINISH  | COOPT    | Transfer finished |
| -9           | ERROR   | PFEIL    | Error return from driver |
| -6           | TMSUB   | MTMRS    | Time-out subroutine |
| -5           | TMR     | 0        | Time-out counter |
| -4           | TMTR    | -4       | Start value of TMR |
...
| -10          | BRKTAB    | BRK6     | Break table                                     |
| -7           | LAST      |          | Last typed character                            |
| -6           | TMSUB     | TTIMR    | Time-out subroutine                             |
| -5           | TMIR      |          | Time-out counter                                |
| -4           | TTIMR     | -3       | Start value of TMR                              |
...
| 1            | RTRES     | 0        | Reserving RT program                            |
| 2            | BWLINK    | *-2      | Beginning of waiting queue                      |
| 3            | TYPRING   | 110040   | Device type bits and ring                       |
| 4            | ISTATE    | 0        | 0 = idle, 1 = busy, -1 = no wait mode           |
| 5            | MLINK     | 0        | Monitor queue link                              |
| 6            | MFUNC     | IORES    | Monitor level function address                  |
| 7            | IOTRANS   | TTGET    | Called from INBT/OUTBT to transfer              |
| 8            | STDEV     | TEXIT    | Start device                                    |
| 11           | SETDV     | CLBUF    | IOSET routine                                   |
| 12           | DFPOP     | DTxxW    | Opposite data field for two-way devices         |
| 13           | DERROR    | 0        | Error code                                      |
| 14           | BUFST     | BUF0 + BUF | Start of ring buffer                           |
...
| 38           | BREGLOCK  | DERO     | Register save on escape                         |
| 40           | DBPREG    | 0        | P register on page fault on IOBT level          |
| 41           | DBCTPRI   | 0        | ACTPRI on page fault on IOBT level              |
| 42           | FLAGB     | see below| Background flag                                 |

Note: "ND-60.112" identifier removed.
...
- 0: not logged in (SBPASSIVE)
- 1: command mode (SBCOMM)
- 2: user mode (SBUSER)
- 3: escape is punched (SBESC)
- 4: error printout (SBERROR)
- 5: remote processing (SBREMOT) (REMOTE)
- 6: rubout is punched (SBREUB) (REMOTE)
- 7: remote file transfer (SCFILTRA)

# Value of TSTATE:

- 0: outside time slice (STIDUM) PRIO. 20
- 1: inside time slice (STLOW) PRIO. 40
- 2: after break character (STHIGH) PRIO. 60
- 3: after break character (PRIO. not yet raised) (5TIREACT)
...
| -6           | TMSUB   | TTOMIR            | Time-out subroutine                                          |
| -5           | TMR     | 0                 | Time-out counter                                             |
| -4           | TMFR    | -10               | Start value of TMR                                           |
| 3            | HDEV    | IOX310+4#         | IOX instruction                                              |
| 2            | STDRIV  | DWRIT             | Start address of driver                                      |
| -1           | DRIVER  | DWRIT             | Restart address after interrupt                              |
| 0            | RESLINK | 0                 | Reservation link                                             |
| 1            | RTRES   | 0                 | Reserving RT program                                         |
| 2            | BWLINK  | *-_2              | Beginning of wait queue                                      |
| 3            | TYPIRG  | 110000            | Device type bits and ring                                    |
| 4            | ISTATE  | 0                 | 0 = idle, 1 = busy, -1 = no wait mode                        |
| 5            | MLINK   | 0                 | Monitor queue link                                           |
| 6            | MFUNC   | IORES             | Monitor level function address                               |
| 7            | IOTRANS | TTPUT             | Called from INBT/OUTBT to transfer                           |
| 10           | STDEV   | DMOUT             | Start device                                                 |
| 11           | SETDV   | CLBUF             | IOSET routine                                                |
| 12           | DFOPP   | DTxxR             | Opposite data field for two-way devices                      |
| 13           | DERROR  | 0                 | Error code                                                   |
| 14           | BUFST   | BUF + BUF         | Start of ring buffer                                         |
| 15           | MAX     | 40 + 40           | Buffer capacity                                              |
| 16           | BHOLD   | 0                 | Number of characters in buffer                               |
| 17           | HENTE   | 0                 | Fetch pointer                                                |
| 20           | CFREE   | 40 + 40           | Free positions                                               |
...
| 32           | ZOPRG   | 0                 | P, X, and T registers in OUTSTRING                           |
...
| -117 | FDIST | | Temporary hardware status |
| -116 | MRETURN | | Address of the 3rd parameter (format number) |
| -115 | FRTRY | | Retrial counter for address mismatch |
| -114 | DINC | | Number of sectors transferred |
| -113 | | | Link for monitor queue (MLINK) |
| -112 | FMDIS | | Address of monitor function routine (MFUNC) |
| -111 | FRTPR FDRT1 | | RT program to fill or empty the buffer |
| -110 | WDCNT | | Word/sector used by the RT program (FDIRT) |
| -107 | FDIMOD | | Disk address modifier (—11 = rev. to EOF, 1 = addr. to EOF) |
| -106 | FCNT1 | | Maximum number of sectors in buffer |
| -105 | FCNT2 | | Counter for sectors in buffer |
| -104 | DPFLG | | Routine switch in driver |
| -103 | DATAF | | Current format number |
| -102 | SECT | | Sector address |
| -101 | SCTIB | | Number of sectors in buffer |
| -100 | FDFORM(3) | | Hardware format (format 0, 1, 2) |
| -75 | LFADDR(3) | | Last legal disk address (format 0, 1, 2) |
| -72 | OLDTAR(3) | | Old track number (unit 0, 1, 2) |
| -67 | NEWTR(3) | | New track number (unit 0, 1, 2) |
| -64 | WDSCT(3) | | Word/sector (format 0, 1, 2) |
| -61 | MSCTB(3) | | Maximum number of sectors allowed in buffer (format 0, 1, 2) |
| -56 | SCTTR(3) | | Sectors/track (format 0, 1, 2) |
| -53 | CALIB(3) | | Calibration flag (unit 0, 1, 2) |
| -50 | NFUADDR(3) | | Next disk address (unit 0, 1, 2) |
...
| -34 | SVLCA | | Not used |
| -33 | CFLRG | | Return address inside TFDISK |
...
| 16 TACNS -12 | Number of retrials wanted before error message |
...
| BWLINK | Beginning of waiting queue |
| TYPIRNG 402 | Device type bits and ring |
| ISTATE | 0 = idle, 1 = busy, -1 = no wait mode |
| MLINK | Monitor queue link |
| MFUNC RETRA | Monitor level function address |
| TRLEQ | Return address on monitor level after transfer |
| HSTAT | Hardware status from driver |
| MTRANS MTRNS | Monitor level routine to activate driver |
| MRTREF | Program calling close |
| BREGC | Address of I/O data field |
...
| 2     | BWLINK   | *-2      | Beginning of waiting queue                    |
| 3     | TYPRING  | 112000   | Device type bits and ring                     |
| 3     | ISTATE   | 0        | 0 = idle, 1 = busy, -1 = no wait mode         |
| 5     | MLINK    | 0        | Monitor queue link                            |
| 6     | MFUNC    | IORES    | Monitor level function address                |
| 7     | IOTRANS  | CBGET    | Called from INBT/OUTBT to transfer            |
| 10    | STDEV    | TEXIT    | Start device                                  |
...
| 23    | PFDEV    | 1146#    | Logical unit number for DF data field         |
| 24    | LREGC    | 0        | Return address after IOTRANS is executed      |
| 25    | CASUN    | x        | Device unit number                            |
| 26    | CERROR   | 0        | Current error code                            |
| 27    | LASTC    | 0        | Current character                             |
...
| 10           | STDEV   | TEXIT    | Start device                                |
| 11           | SETDV   | CAOCL    | IOSET routine                               |
| 12           | DFOPP   | Fylal    | Opposite data field for two-way devices     |
| 13           | DERROR  | 0        | Error code                                  |
| 14           | BUFFER  | 0        | Start of ring buffer                        |
| 15           | MAX     | 0        | Buffer capacity                             |
| 16           | BHOLD   | 0        | Number of characters in buffer              |
| 17           | HENTE   | 0        | Fetch pointer                               |
| 20           | CFREE   | 0        | Free positions                              |
| 21           | FILLE   | 0        | Store pointer                               |
| 22           | CLOGDV  | 1145#    | Logical unit number for DMA data field      |
...
| 36           | MABUF   | 0        | Second word in memory buffer address        |
| 37           | VEFUNC  | 0        | Not used                                    |
| 40           | CILOG   | 1000#    | Logical device number                       |
| 41           | FDIADR  | 0        | Floppy disk address                         |

\# = For controller 1, drive0 (y = 1, x = 0)
...
## Description
NORCOM Graphic Buffer (y = ACM no.2 = bank no.)

| Relat. Addr. | Symbol | Contents | Explanation                               |
|-------------|--------|----------|-------------------------------------------|
| -6          | STAAD  | 0US0     | Routine for PLOTT monitor call            |
| -5          | KLUMP  | 0        | Work cell                                 |
| -4          |        |          | Save cell                                 |
| -3          | HDEV   | 0X40#    | IOX for ACM                               |
| -2          | BCOVN  |          | Work cell                                 |
| -1          | DRIVER |          | Driver address                            |
| 0           | RESLINK|          |                                           |
| 1           | RTRES  |          |                                           |
| 2           | BWLINK | *-2      |                                           |
| 3           | TYPIRNG| 10000    | see DTxxW                                 |
| 4           | ISTATE |          |                                           |
| 5           | MLINK  |          |                                           |
| 6           | MFUNC  | IORES    |                                           |
| 7           | XDWF   | 0        | Increment difference, x coordinate        |
| 10          | YDWF   | 0        | Increment difference, y coordinate        |
| 11          | SETDV  | SETFA    | IOSET routine                             |
| 12          | INNX   |          | Save X register                           |
| 13          | DERRO  |          | Error code                                |
| 14          | RETAD  |          | Return address                            |
| 15          | CURAD  |          | Current ACM address                       |
| 16          | CURDA  | 0        | ACM data                                  |
| 17          | BATEM  | 0        | Bank number                               |
| 20          | BANKB  | 71#      | Blank position                            |
| 21          | COLOR  |          | Current colour                            |
| 22          | OLDX   |          | Previous X coordinate                     |
| 23          | OLDY   |          | Previous Y coordinate                     |
| 24          | TEXT   | -ATEX    | Exit address                              |
...
**Note**: # = ACM no. 1, bank no. 1, (y,z) = (1,1)  
**Document No.**: ND-60.112.01
...
**Note**: `#` = from modem 1 (x = 1)

---

**Document ID**: ND-60.112.01
...
| -5           | TMR     | 0         |                           |
| -4           | TTMR    | -12       |                           |
| -3           | HDEV    | IOX 5D#   | # for modem no. 1 (x = n) |
| -2           | STDRIV  | CTROD     |                           |
| -1           | DRIVER  | 0         |                           |
| 0            | RESLINK | 0         | see HDMIx                 |
| 1            | RTRES   | 0         |                           |
| 2            | BWLINK  | -2        |                           |
| 3            | TYPRING | 202       |                           |
| 4            | ISTATE  | 0         |                           |
...
| -1           | IDEOPP  | Dx00 5   | Pointer to opposite data field       |
| 0            | RESLINK | 0        |                                      |
| 1            | RTRES   | 0        |                                      |
| 2            | BWLINK  | -2       |                                      |
| 3            | TYPRING | 102      |                                      |
...
| Relat. Addr. | Symbol | Contents | Explanation                |
|--------------|--------|----------|----------------------------|
| -1           | IDEFOPP | IDxxll  | Pointer to opposite data   |
| 0            | RESLINK | 0        |                            |
| 1            | RTRES   | 0        |                            |
| 2            | BWLINK  | -2       |                            |
| 3            | TYPING  | 102      |                            |
...
| \-1          | DRIVER   | MODI⋀⋀      | Restart address after interrupt             |
| 0            | RESLINK  | 0           | Reservation link                            |
| 1            | RTRES    | 0           | Reserving RT program                        |
| 2            | BWLINK   | \-2         | Beginning of waiting queue                  |
| 3            | TYPRING  | 110000      | Device type bits and ring                   |
...
| 12           | DFOPP    | 0           | Not used                                    |
| 13           | DERROR   | 0           | Error code                                  |
| 14           | BUFST    | BURF0 + BUF | Start of ring buffer                        |
| 15           | MAX      | MIBUx +     | Buffer capacity                             |
| 16           | BHOLD    | 0           | Number of characters in buffer              |
| 17           | HENTE    | 0           | Fetch pointer                               |
| 20           | CFREE    | MIBUx +     | Free positions                              |
| 21           | FYLLE    | 0           | Store pointer                               |
| 22           | MINBHOLD | 0           | Lower limit for break                       |
| 23           | MAXBHOLD | MIBUx +     | Upper limit for break                       |
...
| 12           | DFOPP   | 0           | Not used                                                  |
| 13           | DERROR  | 0           | Error code                                                |
| 14           | BUFST   | BUF + BUFRO | Start of ring buffer                                      |
...
| 5            | MLINK   | 0        | Monitor queue link                            |
| 6            | MFUNC   | IORES    | Monitor level function address                |
| 7            | IOTRANS | IGTCM    | Called from INBT/OUTBT to transfer            |
| 10           | STDEV   | ISTDV    | Start device                                  |
| 11           | SETDV   | CLBUF    | IOSET routine                                 |
| 12           | DFOPP   |          | Opposite data field for two-way devices       |
| 13           | 0       | 0        | Not used                                      |
| 14           | BUFST   | BUF0 + BUF | Buffer start                                |
| 15           | MAX     | IDBUS +  | Buffer capacity                               |
| 16           | BHOLD   | 0        | Number of characters in buffer                |
| 17           | HENTE   | 0        | Fetch pointer                                 |
...
| 24           | IMAXBHOLD | (2) 11,0 | MAXBHOLD                                     |
| 26           | TERM    | TERMC    | Terminator character                          |
| 27           | CHARI   | 0        | Current character                             |
...
**Description**: Internal device, character arr. output
...
| 14-20        |         | 0        | not used |
| 22           | CLOGDV  | 1210 + XIBNX | Logical unit number for DMA data field |
| 23           | DFVD    | 1210 + YIBNY | Logical unit number for DF data field |
| 24           | LREGC   | 0        | Return address after IOTRANS is executed |
| 25           | CASUN   | 0        | Device unit number |

**Note**: The table provides detailed information about internal device memory addresses, their symbolic names, contents, and explanations for various operations in a system.
...
| Relat. Addt. | Symbol   | Contents | Explanation  |
|--------------|----------|----------|--------------|
| 0            | RESLINK  | 0        |              |
| 1            | RTRES    |          |              |
| 2            | BWULINK  | #2       |              |
...
| 10    | STDEV   | TEXIT    | Start device |
| 11    | SETDV   | CAICL    | IOSET routine |
| 12    | DFOPP   | MTDOx    | Opposite data field for two-way devices |
| 13    | DERROR  | 0 i      | Error code |
| 14    | BUFST   | 0        | Start of ring buffer |
| 15    | MAX     | 4000     | Buffer capacity |
| 16    | BHOLD   | 0        | Number of characters in buffer |
| 17    | HENTE   | 0        | Fetch pointer |
| 20    | CFREE   | 4000     | Free pointer |
| 21    | FYLLE   | 0        | Store pointer |
| 22    | CIOGDV  | 50#      | Logical unit number for DMA data field |
...
*# = For magnetic tape controller 1, drive1 (y = 1, x = 1)*
...
| 12           | DFPOP   | MTDTTI   | Opposite data field for two-way device |
| 13           | DERROR  | 0        | Error code |
| 14           | BUFST   | 0        | Start of ring buffer |
| 15           | MAX     | 4000     | Buffer capacity |
| 16           | BHOLD   | 0        | Number of characters in buffer |
...
| 21           | FVIE    | 0        | Store pointer |
| 22           | CLOGDV  | 560#     | Logical unit number for DMA data field |
| 23           | DFDEV   | 520#     | Logical unit number for DF data field |
| 24           | LREGC   | 0        | Return address after IORANS is executed |
| 25           | CASUN   | x–1      | Device unit number |
| 26           | CERROR  | 0        | Current error code |
| 27           | LASTC   | 0        | Current character |
| 30           | NOWRRE  | 2000     | Number of characters to read/write |
| 31           | CPARM (5)| 1, *+3, *-6, *-4, 0 | Parameter list for MTRANS (including first word in memory buffer address) |
| 36           | MABUF   | 0        | Second word in memory buffer address |
| 37           | VEFUNC  | 0        | Not used |
| 40           | CIOLOG  | 40#      | Logical device number |
...
**Note:** \# = for controller 1, drive1 (y = 1, x = 1)
...
**Description**  
Tandberg/Pertec or HJP. (Mag. tape DMA)
...
| -24 | CDRG | 0 | Register when calling driver first time (REAL = CTRG) |
| -23 | CXRG | 0 | Register when calling driver first time (REAL = CTRG) |
| -22 | ERFCNT | 0 | Number of error returns from driver |
| -21 | SERERB | 1200 | Serious error bits (bit 12: overflow in read, bit 10: data field for channel input Sili/SIII communication) |
| -20 | WERRB |  | Not used |
| -17 | AERRB | 0 | Accumulated error bits |
...
| -6 | TMSUB | MGTMR | Time-out subroutine |
| -5 | TMR | 0 | Time-out counter |
| -4 | TMR | -10 | Start value of TMR |
| -3 | HDEV | 520N## | Hardware device number (i.e., IOX 520) |
| -2 | STDRIV | CTRMA | Start address of driver |
| 0 | DRIVER | 0 | Restart address after interrupt |
| 0 | RESLINK | 0 | Reservation link |
| 1 | RTRES | 0 | Reserving RT program |
| 2 | BWLINK | -2 | Beginning of waiting queue |
...
| 13 | BREG | 0 | Address of I/O data field |
| 14 | MEMA1 | 0 | Initial memory address |
| 15 | MEMA2 | 0 | Initial memory address |
...
| | | |  
|---|---|---|  
| 16 | CMAAD1 | 0 | Current memory address |  
| 17 | CMAD2 | 0 | Current memory address |  
| 20 | CLEDEV | MTCLD | Address of clear device routine |  
...
| 32 | WHSTAT (4) | | Error status in write (unit 0, 1, 2, 3) |  
...
| | |  
|---|---|  
| 0 | 0: 0NOSLICE | Run with fixed priority |  
| 1 | 1: SE8CON | Escape allowed in command mode |  
| 2 | SE8CZSET | Escape has been typed but not served |  
| 3 | 5LOG0UT | Logout on missing carrier |  
| 4 | 5ABJOB | Abort job (error) |  
| 5 | 5OLBRK | Missing carrier on output |  
...
- \# = for digital output number1 (xx = 01)
...
| Relat. Addr. | Symbol    | Contents         | Explanation                                        |
|-------------|-----------|------------------|----------------------------------------------------|
| -17         | CTTYP     | \(9\)            | Terminal type                                      |
| =16         | CESC      | \(253\)          | Escape character                                   |
| =15         | BRKMAX    | \(201\)          | Maximum BHOLD before break                         |
| -14         | ANTORD    | \(25\)           | Number of words to read (for MAGTP)                |
| =13         | XSAC      | \(0\)            | Save X register in IOTRANS                         |
| =12         | DFLAG     | \(206\)          | Flag bits                                          |
| -11         | ECHOTAB   | \(0\)            | Echo table                                         |
| =10         | BRKTAB    | \(0\)            | Break table                                        |
| = 7         | LAST      | \(0\)            | Last typed character                               |
| = 6         | CMDAT     | COMon            | Pointer to communication data field                |
| = 5         | IXSAC     | \(0\)            | Save data field for magnetic tape                  |
| = 4         | ANTMEL    | \(0\)            | Number of frames in input queue                    |
| = 3         | BYTS      | \(0\)            | Byte counter in frame                              |
| = 2         | INGR      | \(3\)            | Byte counter in buffer                             |
| = 1         | CHAN      | cmn \(=1\)       | Channel number (0 - 37 octal)                      |
| 0           | RESLUNK   | \(0\)            | Reservation link                                   |
| 1           | RTRES     | \(0\)            | Reserving RT program                               |
| 2           | BWLUNK    | \*-2             | Beginning of waiting queue                         |
| 3           | TYPRING   | 116060           | Device type bits and ring                          |
| 4           | ISTATE    | 0                | 0 = idle, 1 = busy, -1 = no wait mode              |
| 5           | MLUNK     | 0                | Monitor queue link                                 |
| 6           | MFUNC     | CIORE            | Monitor level function address                     |
| 7           | IOTRANS   | SSTI             | Called from INBT/OUTBT to transfer                 |
| 10          | STDEV     | TEXIT            | Start device                                       |
| 11          | SETDEV    | CLSBI            | IOSET routine                                      |
| 12          | DFPOP     | SmmnW            | Opposite data field for two-way devices            |
| 13          | DERROR    | \(0\)            | Error code                                         |
| 14          | MSSTART   | \(o\)            | Pointer to first buffer of frame                   |
| 15          | PLMSG     | \*               | Last frame of input queue                          |
| 16          | PFMSG     | \(9\)            | First frame of input queue                         |
| 17          | CURBU     | oooo             | Current input buffer                               |
| 20          | CHNST     | ooooooo          | Channel input status                               |
| 21          | LRSA      | ooooooooo        | Save L register in IOTRANS                         |
| 22          | BSSTATE   | ooooooooo        | Background program state                           |
| 23          | TSTATE    | ooo              | Time slice state                                   |
| 24          | DBPROG    | Cmmn             | Background RT program                              |
| 25          | DBADDR    | \(a /aa\)        | Saved P register on escape + file system monitor call |
| 26          | RWFK      | \(a /aa\)        | For MODE (input file number)                       |
| 27          | BCHSTS    | \(9\)            | For MODE (input status)                            |
| 30          | DER 0(12) | \(0\)            | Register block                                     |
| 32          | DER 2(16) | \(9\), -,-,-     | Register block                                     |
| BREG        |           |                  |                                                    |
| BLOCK=      |           |                  |                                                    |
| DER0        |           |                  | Register save at escape                            |
| 40          | DBPREP    | \(9\) \(9\)      | P register on page fault on IOBT level             |
| 41          | DBATPRI   | \(9\) \(9\)      | ACTPRI on page fault on IOBT level                 |
| 42          | FLAGB     | \(9\)            | Background flag                                    |
| 43          | RTTUT     | \(9\) Umnn       | RT description of file transfer program            |
...
| -11          | ECHOTAB | ECHO      | Pointer to echo table                                  |
| -10          | BRKTAB  | 0         | Pointer to break table                                 |
| -7           | LAST    | 0         | Save last byte                                         |
| -6           | CMDAT   | CMO       | Pointer to communication data field                    |
| -5           | MSIZE   | BUSIZ+    | Maximum number of bytes in a frame (406 octal)         |
| -4           | SCPRI   | 0         | Channel priority                                       |
| -3           | BYTS    | 0         | Byte counter in frame                                  |
| -2           | INCR    | 0         | Byte counter in buffer                                 |
| -1           | CHAN    | mn=11     | Channel number (0-37 octal)                            |
| 0            | RESLINK | 0         | Reservation link                                       |
| 1            | RTRES   | 0         | Reserving RT program                                   |
| 2            | BWLINK  | *-2       | Beginning of waiting queue                             |
| 3            | TYPIRG  | 116000    | Device type bits and ring                              |
| 4            | ISTATE  | 0         | 0 = idle, 1 = busy, -1 = no wait mode                  |
| 5            | MLINK   | 0         | Monitor queue link                                     |
| 6            | MFUNC   | CIORE     | Monitor level function address                         |
...
| 13           | DERRO   |     ^    |                                 |
| 14           | RETAD   |     å    |                                 |
| 15           | CUAD    |     ç    | Current ACM address             |
| 16           | CHSTA   |     @    | ACM data                        |
| 17           | BANKN   | z        | Bank number                     |
| 20           | RUNMO   |     ℓ    | Program mode                    |
| 21           | MAXAD   | @277#    | Maximum address semigraphic     |
| 22           | SAVE    |     ℓ    | Screen direction increment      |
| 23           | INKRE   |     ℓ    | Screen direction increment      |
| 24           | NOSTA   |     çêç  | Screen addressing modus         |
| 25           | CURIN   |     çê   | Screen addressing modus         |
| 26           | SAM1L1  |    ℓ     | Parameters for ACM address      |
| 27           | SAML2   |  çê    ç | Parameters for ACM address      |
| 30           | SAML3   |     çêçê | Parameters for ACM address      |
| 31           | NOVI    |     @    | Address for RTCOMMON semigraphic buffer |
| 32           | NOVO    |     @    | Number of words for RTCOMMON semigraphic buffer |
...
| 0            | SPOLPRO-GRAM   | SPOOL      |                                                         |
| 1            | RTDESRIPTI-ON  | SPRTx      | Address to RT description                               |
...
| 7            | ABORF          | 0          | Abort command flag:                                     |
|              |                |            | 1 = abort current print; 2 = restart current print;     |
|              |                |            | 3 = stop print; bit 8 =11 = forward space print;        |
|              |                |            | bit 9 =11 = backspace bit; bit 10 = 1 = new file is set |
|              |                |            | first in queue                                          |
...
| 16           | REMAININDVGO   | 0          | Byte number on last page                                |
| 17           | BYTENUMBER     | 0          | Current byte number                                     |
| 20           | FPARLIST       | 0          |                                                         |
| 21           | FPARDLIST      | 0          |                                                         |
| 22           | BUFFAD         | 74000      | Device buffer                                           |
| 23           | FPAR1LIST      | 0          |                                                         |
| 24           | FPAR2LIST      | 0          |                                                         |
| 25           | PRINPAR        | EVEN       | ABSTRANS parameter list                                 |
| 26           | BUFPEK         | +3         | ABSTRANS parameter list                                 |
| 27           | DUMPADR        | $000       | ABSTRANS parameter list                                 |
| 30           | BYTNPEK        | ←−11       |                                                         |
| 31           | PCORAD (2)     | 0,0        |                                                         |
| 33           | PRSEGMI        | 177400     | SPSGX +11 Buffer segment                                |
| 34           | CMAPfl         | 0          | Memory map element                                      |
...
| 42           | SNLlPAGE       | 104        | Number of lines on one page                             |
| 43           | SPMODE         | 0          | 0 = print, 1 = plot                                     |
| 44           | SPAGENUM-BER   | 0          | Saved page number                                       |
| 45           | WSNLlNE        | 0          | Temporary SNLlNE                                        |
| 46           | WSNPAG!E       | 0          | Temporary SNPAGE                                        |
...
| 61      | QELEM (0)        | 0     | Buffer for one queue element         |
...
**Note:**  
1. Relative address 0 corresponds to label SPPRx -1 (B register points to SPPRx -1 in driver)
...
| 14 | RETAD | OUTIY | Return address |
| 15 | NOADR | 0 | Current ACM address |
| 16 | NODAT | 0 | ACM data |
| 17 | XVS0 | 0 | X address screen 0 |
| 20 | YVS0 | 0 | Y address screen 0 |
...
| 27 | SMTI0 | 0 |  |
| 30 | SMTI1 | 0 | Pointer to current selector module |
| 31 | SMT2 | 0 |  |
| 32 | SMT3 | 0 |  |
| 33 | RTRI0 | 0 |  |
| 34 | RTRI1 | 0 | Wait flag for screen 0-3 |
| 35 | RTR2 | 0. |  |
| 36 | RTR3 | 0 |  |
...
| —2 | STDRIV | CTIDR# | Start address of driver |
| —1 | DRIVIER | CTIDR# | Restart address after interrupt |
| 0 | RESLINK | 0 | Reservation link |
| 1 | RTRES | 0 | Reserving RT program |
| 2 | BWLINK | *—2 | Beginning of waiting queue |
...
| 13 | HN | TEXIT# | I/O initiating routine |
| 14 | NPBUF | 0 | Current buffer chain used by input driver |
| 15 | SMWCH | 0 | Go switch for input driver |
| 16 | NPHBUF | 0 | Current buffer chain read by receive RT program |
| 17 | CUDDU | 0 | Current buffer filled by driver |
| 20 | IDBSTM# | 0,0,0,4 | Status of buffer chain n (0 = empty, 6 = filled) |
| 27 | IDBADM# | CH2, CH430,0,0 | Address of first buffer in chain n |
...
| -2           | STDRIV   | CT1DR#    | Start address of driver         |
| -1           | DRIVER   | CTDDR#    | Restart address after interrupt |
| 0            | RESLINK  | 0         | Reservation link                |
| 1            | RTRES    | 0         | Reserving RT program            |
| 2            | BWLINK   | -2        | Beginning of waiting queue      |
| 3            | TYPRING  | 2         | Device type bits and ring       |
...
| 6            | MFUNC    | IORES     | Monitor level function address  |
| 7            | CHKO     | 0         | Character pointer in input buffer |
| 10           | STDEV    | CRWW/AII# | Start device                    |
| 11           | ANCHA    | 0         | Character counter for input driver |
| 12           | DFOPP    | TTULn     | Opposite data field for two-way devices |
| 13           | IIN      | TEXTI#    | I/O initiating routine          |
| 14           | LIBEG    | 0         | Start of buffer descriptor list |
| 15           | SWICH    | 0         | Go switch for input driver      |
| 16           | HPEK     | 0         | Current buffer chain read by receive RT program |
| 17           | CUBDU    | 0         | Current buffer filled by driver |
...
| 12           | DFOPP   | TTILa    | Opposite data field for two-way devices         |
| 13           | RSICH   | CRSVII#  | Reset device routine                            |
| 14           | BUFST   | 0        | Pointer to first buffer of current output buffer chain |
| 15           | SWICH   | 0        | Go switch for output driver                     |
| 16           | LMDATA  | CMO1n    | Pointer to communication data field             |
...
| -5           | TMR       | 0        | Time-out counter                             |
| -4           | TTMR      | -3       | Start value of TMR                           |
| -3           | HDEV      | IOX104#  | IOX instruction (i.e., IOX 104)              |
...
| 5            | MLINK     | 0        | Monitor queue link                           |
| 6            | MFUNC     | IORES    | Monitor level function address               |
| 7            | IOTRANS   | MOTRO    | Called from INBT/OUTBT to transfer           |
| 10           | STDEV     | TEXIT    | Start device                                 |
| 11           | SETDV     | MOSTIO   | IOSET routine                                |
| 12           | DFOPP     | 0        | Not used                                     |
| 13           | DERROR    | 0        | Error code                                   |
| 14           | BUFST     | BUF0 + BUF | Start of ring buffer                        |
...
| Relat. Addr. | Symbol  | Contents      | Explanation                                       |
|--------------|---------|---------------|---------------------------------------------------|
| -11          | ADRBHEAD| 0             | Buffer head address                               |
| 0            | RESLINK | 0             | Reservation link                                  |
| 1            | RTRES   | 0             | Reserving RT program                              |
| 2            | BWLINK  | \*-2          | Beginning of waiting queue                        |
| 3            | TYPRING | 112000        | Device type bits and ring                         |
| 4            | ISTAT0  | 0             | 0 = idle, 1 = busy, -1 = no wait mode             |
| 5            | MLINK   | 0             | Monitor queue link                                |
| 6            | MFUNC   | IORES         | Monitor level function address                    |
| 7            | IOTRANS | CBPUT         | Called from INBT/OUTBT to transfer                |
| 10           | STDEV   | TEXIT         | Start device                                      |
| 11           | SETDV   | VEICL         | IOSET routine                                     |
| 12           | DFPOP   | 0             | Opposite data field for two-way devices           |
| 13           | DERROR  | 0             | Error code                                        |
| 14           | BUFST   | 0             | Start of ring buffer                              |
...
| Relat. Addr. | Symbol    | Contents | Explanation                                      |
|--------------|-----------|----------|--------------------------------------------------|
| 52           | ADNSTYL(4)| 0,...,0  | Not used                                         |
| 46           | SHSTAT(4) | 0,...,0  | Saved last status (unit 0, 1, 2, 3)              |
| 42           | CERRCODE  | 0        | Current error code                               |
| 41           | MAXUNIT   | 889NDV/# | Maximum unit number on this controller           |
| 40           | MACOU     | 0        | Erase counter                                    |
...
| 1            | RTRES     | 0        | Reserving RT program                             |
| 2            | BWLINK    | *,-2     | Beginning of waiting queue                       |
| 3            | TYPRING   | 6        | Device type bits and ring                        |
| 4            | ISTATE    | 0        | 0 = idle, 1 = busy, -1 = no wait mode            |
| 5            | MLINK     | 0        | Monitor queue link                               |
| 6            | MFUNC     | RETRA    | Monitor level function address                   |
| 7            | TRLEG     | 0        | Return address on monitor level after transfer  |
| 10           | HSSTAT    | 0        | Hardware status from driver                      |
| 11           | MTRANS    | MTRNS    | Monitor level routine to activate driver         |
| 12           | MRTREF    | 0        | Program calling CLOSE                            |
| 13           | BREGC     | 0        | Address of I/O data field                        |
| 14           | MEMA1     | 0        | Initial memory address                           |
| 15           | MEMA2     | 0        | Initial memory address                           |
| 16           | CMAD1     | 0        | Current memory address                           |
| 17           | CMAD2     | 0        | Current memory address                           |
| 20           | CLEDEV    | VDMAC    | Address of clear device routine                  |
| 21           | PVEFUNC   | VED01 + 37# | Address of VEFUNC in HQ data field             |

Note: # indicates for controller number 11 (VEFIE)
...
| 3   | 5MDUP     | Half duplex                                                |
| 4   | 5FIMO     | Fixed line modem interface                                 |
| 5   | 5RQI      | SINTRAN III communication                                  |
| 6   | 5WRQI     | SINTRAN III communication                                  |
| 7   | 5XON      | Print XON as next output character (XON = 21)              |
...
4 Asynchronous Current Loop (11122 Card) and Dual Asynchronous V24 (1147 Card)
...
|------|--------|--------------------------------------------|
|      |        | Ring number                                |
| 1    | 5CLDV  | Clear device routine available             |
| 2    | 5NORES | No reservation necessary (terminal output) |
| 3    | 5REMPO | Communication channel used for remote file access |
| 4    | 5TERM  | Terminal                                   |
| 5    | 5IBDV  | Internal block devices                     |
| 6    | 5INVERT| Invert digital I/O                         |
| 7    | 5FLOP  | Floppy disk                                |
| 8    | 5MT    | Magnetic tape                              |
| 10   | M144B  | Block monitor calls allowed                |
...
| 7AIRx        | 82ONx              |
| 7DOxx        | NDlBxx             |
| 7DPHx        | DPflOTx, DIPH0x    |
| 7GRCx        | GRxR, GRxRW        |
| 7HARx        | HAxR, HHA0xW       |
| 7TEx         | DTEIx, DTlLxxW     |
| 8BCHx        | BTXR, BFlTxxOW     |
| 8BDx         | BIGDlx, BIGD12     |
| 8CACS1       | CADlx, CADOxx, CAFIE |
| 8CALC        | CALC0              |
| 8CAS2        | CADlx3CADOxx       |
| 8CDxx        | CDFxx              |
| 8CPx         | CAflX              |
...
| 8Fl6         | DMAX               |
| 8FlIDx       | FDIIDX             |
| 8FyUx        | FyUDlx, IFyuxUo    |
| 8HDMx        | HDuFEx, HDIFPxOX, HDIWfX, HDIAfl0x, HDflWlOx |
| 8LPx         | DlLPR, DlLPRx      |
| 8M1U(Ux-J)   | MTDlx, MTD0xx      |
| 8M%2(lix-IT) | M2DlIx, M%2D0Ox    |
| 8MT2         | MTFIE, M2FIE       |
| 8NEO         | DRfl50             |
| 8N50x        | DF8xx50x           |
| 8NCA2        | CALN2              |
...
| 8REA2        | DREA2              |
| 8S3C         | NDEMIE, NODEM2     |
| 8SMl0x       | IDMOx, IDMIxx, UDM0xx, UDMxx |
| 8SMxx        | SEMlx, SEflMxx     |
| 9MHMT        | MTFIE, M2Ffl2      |
| 9MTMT        | MTFIE, M2Fl2       |
| 9ACMx        | DACMx              |
| 9SME0x       | IDMOx, IDMxx, UDMOx, UDMxx |
...
NORSK DATA AS OLAF HELSETS VEI 5 P.O. BOX 25 BOGERUD 0621 OSLO 6 NORWAY  
