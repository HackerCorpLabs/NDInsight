...
**File:** Source Code\Sintran L\NPL\RP-P2-N500.NPL
**Total Lines:** 1035
...
```npl
5ALIVE       % CPU is alive and available (5ALIV=000015 = bit 13 in CPUAVAILABLE)
...
5POWOF       % Power off detected (5POWO=000010 = bit 8 in RSTA5)
```

**Note:** 5ALIVE (5ALIV=000015) is bit 13 in CPUAVAILABLE word, NOT in the RSTA5 status register.
...
**Source File:** Source Code\Sintran L\NPL\RP-P2-N500.NPL
