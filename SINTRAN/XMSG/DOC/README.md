...
| [XMSG-HANDOFF-2026-07-27.md](XMSG-HANDOFF-2026-07-27.md) | **START HERE** - state of the XMSG work: what the library is, what was captured and how, every open item with its next step, and the traps that cost time |
