...
namespace NDInsight.Sintran.Xmsg.Ethernet.Tests
{
    ...
    public sealed class NdLinkLayerTests
    {
        ...
        private static byte[] BuildPeerDataFrame(byte sequence, byte[] datagram)
        {
            ...
            NdLinkHeader.Data(sequence, PeerLinkId, LocalLinkId, (ushort)datagram.Length).Write(llcPayload);
        ...
        public void ReceivedDataFrameIsAcknowledgedWithSequencePlusOne()
        {
            ...
            Assert.Equal(LocalLinkId, header.SenderLinkId);
            Assert.Equal(PeerLinkId, header.ReceiverLinkId);
        }
        ...
        public void OutgoingDataFramesIncrementTheSequence()
        {
            ...
            Assert.Equal(PeerLinkId, first.ReceiverLinkId);
        ...
        public void UnknownFrameKindIsSurfaced()
        {
            ...
            byte reported = 0;
            layer.UnknownFrameKindReceived += kind => reported = kind;
        ...
        public void TwoNodesOnASegmentExchangeADatagram()
        {
            ...
            NdLinkHeader.Data(0x01, 0x59C1, 0x0000, (ushort)hello.Length).Write(llcPayload);
