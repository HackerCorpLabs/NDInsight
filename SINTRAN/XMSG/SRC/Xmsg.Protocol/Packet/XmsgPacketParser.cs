...
namespace NDInsight.Sintran.Xmsg.Packet
{
    ...
    public static class XmsgPacketParser
    {
        ...
        /// </summary>
        /// <param name="data">The information-field bytes, starting at Marker 1 (offset 0).</param>
        /// <returns>The decoded <see cref="XmsgPacketInfo"/>.</returns>
        ...
        /// </summary>
        /// <param name="data">The candidate information-field bytes.</param>
        /// <param name="packet">On success, the decoded packet; otherwise <c>null</c>.</param>
        /// <returns><c>true</c> when a packet was decoded; otherwise <c>false</c>.</returns>
