...
namespace NDInsight.Sintran.Xmsg.Ethernet
{
    ...
    /// <i>"each Ethernet Interface has in fact four physical addresses"</i>. DIX (TCP/IP) and
    ...
    /// <para>
    /// The manual's words: <i>"ND system numbers, in the range 0 - 177777B, are contained (in
    /// reversed order) in characters 4-5 of the address string. Physical user numbers are contained
    /// in character 6."</i> So the field is a full 16 bits - <c>0</c> to <c>65535</c>.
    /// </para>
